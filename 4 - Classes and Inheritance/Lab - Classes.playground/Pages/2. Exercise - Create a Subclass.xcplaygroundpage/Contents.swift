...
class Fighter: Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            ...
            print("Fired! Remaining firepower: \(remainingFirePower)")
        }
        else{
...
destroyer.moveRight()
print("New position: \(destroyer.position)")
...
//falcon is instance of type spaceship and its parent class of fighter but weapon is property of only fighter class
//Child class can inherit properties of parents but vice-versa is not true.
