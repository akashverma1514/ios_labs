...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "akashverma", email: "akashverma@gmail.com", age: 20)
 ...
 */
let newUser = User(userName: "Riya Sharma", email: "riya@example.com", age: 22)
